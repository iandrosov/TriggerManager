...
%scope param(filename='./packages/TriggerManager/config/ui.cnf')%
%invoke TriggerManager.admin:mainMenu%
...
%loop sections%
    ...
    <TR><TD CLASS="menusection-%value name%">
       <img src="/WmRoot/images/blank.gif" width="4" height="1" border="0">%value text%
    </TD></TR>
...
<form name="urlsaver">
<input type="hidden" name="helpURL" value="doc/OnlineHelp/CS_Server_Statistics.htm">
</form>
</div>
</BODY>
</HTML>
